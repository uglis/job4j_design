...
public class AccountsReport implements Reports {
    private Store store;

    public AccountsReport(Store store) {
        this.store = store;
    }
    ...
    public String generateJson(Predicate<Employee> filter) {
        ...
        for (Employee employee : store.findBy(filter)) {
            sb.append("{").append(System.lineSeparator())
                    ...
                    .append(String.format("\"salary\": \"%s\"", (int) employee.getSalary())).append(System.lineSeparator())
    ...
    public String generateXml(Predicate<Employee> filter) {
        ...
        for (Employee employee : store.findBy(filter)) {
            sb.append("<employee>").append(System.lineSeparator())
                    ...
                    .append(String.format("<salary>%s</salary>", (int) employee.getSalary())).append(System.lineSeparator());
        }
        sb.append("</employee>").append(System.lineSeparator());
        return sb.toString();
    }
